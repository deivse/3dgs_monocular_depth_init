...
from metric3d.mono.utils.comm import main_process
import copy
import inspect
import logging
import glob
...
def save_ckpt(
    cfg, model, optimizer, scheduler, curr_iter=0, curr_epoch=None, loss_scaler=None
):
    """
